...
importable from either the M.U.S.E. venv or the muse-dsh specialists venv. So
...
# command substitution (`$(muse cockpit token)`), or a sentinel constant — a
