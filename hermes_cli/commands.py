...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("busy", "Control what Enter does while muse is working", "Configuration",
    ...
    CommandDef("update", "Update muse to the latest version", "Info"),
    CommandDef("version", "Show muse version", "Info", aliases=("v",)),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to muse or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
