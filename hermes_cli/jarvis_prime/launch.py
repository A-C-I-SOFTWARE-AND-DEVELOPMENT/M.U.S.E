...
1. JARVIS Prime runtime availability
...
class LaunchSummary:
    ...
    def render(self) -> str:
        lines = ["JARVIS Prime — free-first launch", ""]
        for s in self.steps:
        ...
        lines.append("")
        if self.ok:
            lines.append("LAUNCH COMPLETE ✓  JARVIS Prime is ready.")
        else:
            lines.append(
...
def launch(
    *,
    ...
    try:
        ...
        steps.append(LaunchStep("runtime", True, "JARVIS Prime runtime available"))
