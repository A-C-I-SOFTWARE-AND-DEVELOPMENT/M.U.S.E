...
(:mod:`hermes_cli.jarvis_prime.semantic_frontend` →
:mod:`hermes_cli.jarvis_prime.ir_compilers`) into the **existing** owner-gated
learning-dataset pipeline (:mod:`hermes_cli.jarvis_prime.learning_dataset`) and
...
* :func:`export_compile_trace` — turn a verified NL-compile
  (:class:`~hermes_cli.jarvis_prime.ir_compilers.base.CompileResult` + its
  :class:`~hermes_cli.jarvis_prime.semantic_frontend.ParseResult`) into a
  :class:`~hermes_cli.jarvis_prime.learning_dataset.DatasetCandidate`. The
...
def export_compile_trace(
    ...
    *,
    ...
    ``compile_result`` is a
    :class:`hermes_cli.jarvis_prime.ir_compilers.base.CompileResult` and
    ``parse`` is the
    :class:`hermes_cli.jarvis_prime.semantic_frontend.ParseResult` it was
    compiled from.
    ...
    :class:`~hermes_cli.jarvis_prime.learning_dataset.RejectedTrace` on anything
