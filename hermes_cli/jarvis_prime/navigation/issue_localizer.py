...
This is the heart of the HyperAgent-style navigator. It deliberately does
...
is explainable (and auditable in the job ledger):
...
from hermes_cli.jarvis_prime.navigation.repo_index import IndexedFile, RepoIndex
