"""Benchmark validation gate for JARVIS Prime self-improvement.
...
:mod:`hermes_cli.jarvis_prime.gates`, so it composes with
...
from hermes_cli.jarvis_prime.gates import Gate, GateOutcome, GateResult, _get
