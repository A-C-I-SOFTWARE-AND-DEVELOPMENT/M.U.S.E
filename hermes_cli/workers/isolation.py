...
def workspace_path(
    ...
    sanitized to the safe charset enforced by :mod:`hermes_cli.worktrees`
...
def prepare_workspace(
    ...
    *,
    ...
    created via :func:`hermes_cli.worktrees.create_worktree`. The
...
def cleanup_workspace(
    ...
    * Attached worktree: only removed when ``cleanup_worktree=True``,
      and only via :func:`hermes_cli.worktrees.cleanup_worktree` so the
