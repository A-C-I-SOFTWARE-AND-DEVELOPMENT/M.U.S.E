...
:mod:`hermes_cli.jarvis_prime.sia_self_improve`, which turns a
...
from hermes_cli.workers.isolation import IsolationError, prepare_workspace
from hermes_cli.workers.registry import register
from hermes_cli.workers.sia_assets import materialize_task_dir
