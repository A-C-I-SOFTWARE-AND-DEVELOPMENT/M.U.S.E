...
_BUILTIN_FAMILIES: tuple[OssModel, ...] = (
    ...
    OssModel(
        ...
        benchmarks=(),
        providers=(
            ProviderRef("qwen-oauth", "qwen3-vl"),
            ProviderRef("openrouter", "qwen/qwen3-vl"),
            ProviderRef("ollama", "qwen3-vl"),
        ),
        why="Most capable open vision-language model; leads multimodal doc/image.",
    ),
    OssModel(
        id="qwen-omni",
        vendor="Alibaba",
        ...
        params="any-to-any (text/audio/image/video)",
        local=False,
        best_for=("multimodal",),
        benchmarks=(),
        providers=(
            ProviderRef("qwen-oauth", "qwen3-omni"),
            ProviderRef("openrouter", "qwen/qwen3-omni"),
        ),
        why="Open any-to-any model at open-SOTA on most audio + AV benchmarks.",
    ),
    ...
    OssModel(
        ...
        local_runner="ollama",
        best_for=("embeddings",),
        benchmarks=(("mteb_v2", 75.0),),
        providers=(
            ProviderRef("ollama", "qwen3-embedding"),
            ProviderRef("huggingface", "Qwen/Qwen3-Embedding-8B"),
        ),
        why="Top open-weight retrieval embedding on MTEB v2; runs locally.",
    ),
    OssModel(
        id="bge-m3",
        vendor="BAAI",
        ...
        context_window=8192,
        params="568M dense (dense+sparse+ColBERT)",
        local=True,
        local_runner="ollama",
        best_for=("embeddings",),
        benchmarks=(),
        providers=(
            ProviderRef("ollama", "bge-m3"),
            ProviderRef("huggingface", "BAAI/bge-m3"),
        ),
        why="Most-downloaded multilingual embedding; robust local retrieval.",
    ),
    OssModel(
        id="qwen3-reranker",
        vendor="Alibaba",
        ...
        benchmarks=(),
        providers=(
            ProviderRef("huggingface", "Qwen/Qwen3-Reranker-8B"),
            ProviderRef("ollama", "qwen3-reranker"),
        ),
        why="Open cross-encoder reranker that sharpens retrieval ordering; local.",
    ),
    OssModel(
        id="bge-reranker",
        vendor="BAAI",
        ...
        benchmarks=(),
        providers=(
            ProviderRef("huggingface", "BAAI/bge-reranker-v2-m3"),
            ProviderRef("ollama", "bge-reranker"),
        ),
        why="Classic lightweight local reranker (BGE v2-m3); offline fallback.",
    ),
)
...
_BUILTIN_ROUTING: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    # Gemma is only ever a trailing local fallback for review / research / cite.
    ("coding_review", ("glm-5", "deepseek-v4", "qwen3-coder", "gemma4")),
    (
        "citation_verification",
        ("deepseek-r1", "qwen3-235b", "glm-5", "gemma4"),
    ),
