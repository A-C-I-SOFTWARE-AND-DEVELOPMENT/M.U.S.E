...
TIPS = [
    ...
    "Ctrl+Z suspends muse to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs muse itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire muse home directory.",
    ...
    "hermes gateway install sets up muse as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call muse tools programmatically — results stay out of context.",
    ...
    "When exiting, muse prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "muse runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to muse via a local macOS server.",
    ...
    "muse loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs muse as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make muse your own.",
    ...
    "Before a gateway session reset, muse auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — muse auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of muse config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while muse is working.',
    ...
    'hermes dashboard embeds the full muse TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes import restores a full muse backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes muse block commands when the tirith scanner itself errors out.',
