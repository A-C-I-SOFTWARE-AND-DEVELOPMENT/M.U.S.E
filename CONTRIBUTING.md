...
```bash
git clone --recurse-submodules https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent.git
cd hermes-agent
...
- Use [GitHub Issues](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent/issues)
