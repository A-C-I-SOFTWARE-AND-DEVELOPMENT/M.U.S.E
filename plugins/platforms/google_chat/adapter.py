...
#     fresh "muse is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "muse is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'muse is thinking…' marker message.
        ...
        "muse is thinking…" stuck in chat forever, plus one card that
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "muse is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "muse is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "muse is thinking…" card during any subsequent
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        platform_hint=(
            ...
            "are generating a response, a 'muse is thinking…' marker message "
