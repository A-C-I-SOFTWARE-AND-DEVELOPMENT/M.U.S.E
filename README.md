...
Use any model you want — [OpenRouter](https://openrouter.ai) (200+ models), [NovitaAI](https://novita.ai), [NVIDIA NIM](https://build.nvidia.com), [Cerebras](https://cloud.cerebras.ai) (wafer-scale, ~1,000-3,000 tok/s), [z.ai/GLM](https://z.ai), [Kimi/Moonshot](https://platform.moonshot.ai), [MiniMax](https://www.minimax.io), [Hugging Face](https://huggingface.co), OpenAI, or your own endpoint. Switch with `muse model` — no code changes, no lock-in.
...
<tr><td><b>An autonomous-enterprise council</b></td><td>The AXIOM Swarm ecosystem — 670+ agent-capable definitions marshaled by the AXIOM orchestrator: 261 AOS council agents across 17 specialist domains, 142 procedural skills, 27 .claude/dotclaude agent definitions, 149 Python runtime modules, 13 swarm grain modules, and 31 AXIOM kernel modules — convened for audits, launch readiness, and multi-perspective review.</td></tr>
...
- **AXIOM Swarm agent ecosystem** — a routed catalog of **670+ agent-capable definitions**: 261 AOS council agents across 17 specialist domains, 142 procedural skills, 27 `.claude`/`dotclaude` agent definitions, 149 Python agent runtime modules, 13 swarm grain modules, and 31 AXIOM kernel modules — all convened, routed, and governed by the AXIOM orchestrator for audits, hardening, launch readiness, and multi-perspective review. See [`skills/aos-enterprise-council/`](skills/aos-enterprise-council/) and [`SWARM_CAPABILITY_REPORT.md`](SWARM_CAPABILITY_REPORT.md).
...
- **AXIOM verification kernel** — a vendored kernel at [`axiom/`](axiom/) providing a hash-chained event ledger, risk-tiered HTN gates, FSRS-spaced belief memory, AGM belief revision, a forge (ratings, matchmaking, tournaments) for model/agent evaluation, and measured-trust governance bands with earned autonomy and sovereignty clauses. The runtime talks to it through one module: [`hermes_cli/jarvis_prime/axiom_bridge.py`](hermes_cli/jarvis_prime/axiom_bridge.py). See [`docs/axiom-integration.md`](docs/axiom-integration.md).
...
- **670+ agent-capable definitions** — the AXIOM Swarm ecosystem marshals a combined roster of **261 AOS council agents** (across 17 specialist domains: architecture, business, compliance, executive, HazMat Command, hermes, memory, nourish, product, psychology, QA, release, research, security, UX, Claude Code, Codex), **9 specialists + 9 workers + 7 runnable agents + 22 templates** in the AOS operating registry, **142 procedural skills** (each a callable agent procedure), **27 `.claude`/`dotclaude` agent definitions**, **149 Python agent modules** (runtime adapters, provider bridges, memory, caching), **13 swarm grain modules** (decompose, specialize, converge, learn), and **31 AXIOM kernel modules** (forge, governance, memory, orchestrator, interface). Every one of these can be routed, spawned, or convened by the AXIOM orchestrator.
