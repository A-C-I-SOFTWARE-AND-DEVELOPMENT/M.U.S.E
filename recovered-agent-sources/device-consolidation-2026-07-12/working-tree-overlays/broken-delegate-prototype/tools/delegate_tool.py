...
def _build_child_agent(
    ...
    if toolsets is not None:
        ...
        # Important: an explicit empty list means "no tools" for a child
        # health-check/synthesis task.  The previous truthiness check treated
        # [] the same as omitted and silently inherited every parent tool,
        # which could make minimal subagent probes perform accidental tool calls.
