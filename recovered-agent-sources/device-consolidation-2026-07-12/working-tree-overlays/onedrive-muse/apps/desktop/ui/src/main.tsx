...
import { App } from "./App";
import { autoPairLocal, initializeCredentialStore } from "./lib/gateway";
...
// Zero-touch connect: hydrate the OS credential vault, then silently pair with
// the loopback gateway before first paint. The timeout keeps startup instant if
// the gateway is still booting; App's health tick retries afterward.
void Promise.race([
  (async () => {
