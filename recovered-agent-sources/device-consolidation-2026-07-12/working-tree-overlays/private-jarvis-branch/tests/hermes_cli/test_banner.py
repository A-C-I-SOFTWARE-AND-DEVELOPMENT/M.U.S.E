...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    with (
        ...
        console = Console(file=buf, force_terminal=True, color_system="truecolor", width=160, legacy_windows=False)
    ...
    assert "JARVIS Prime v" in raw, "Version label missing from title"
