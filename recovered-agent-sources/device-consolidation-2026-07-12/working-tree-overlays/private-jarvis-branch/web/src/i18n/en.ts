...
export const en: Translations = {
  ...
  app: {
    ...
    footer: {
      org: "A-C-I Software and Development",
    },
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update JARVIS Prime",
    updatingHermes: "Updating JARVIS Prime…",
  ...
  achievements: {
    hero: {
      ...
      title: "JARVIS Prime Achievements",
      subtitle:
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in JARVIS Prime ☤",
    },
  },
