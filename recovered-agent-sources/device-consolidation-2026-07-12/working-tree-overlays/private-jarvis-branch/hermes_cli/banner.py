...
HERMES_AGENT_LOGO = """[bold #FFD700]       JARVIS PRIME[/]
[#FFBF00] local-first AI operating partner[/]
[dim #B8860B]  strategy | voice | memory | tools | code[/]"""
...
_UPSTREAM_REPO_URL = "https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent.git"
...
def format_banner_version_label() -> str:
    ...
    base = f"JARVIS Prime v{VERSION} ({RELEASE_DATE})"
