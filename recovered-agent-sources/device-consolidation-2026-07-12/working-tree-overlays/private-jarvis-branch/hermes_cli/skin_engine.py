"""JARVIS Prime CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "JARVIS Prime"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ JARVIS "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "JARVIS Prime"
...
- ``default`` — Classic JARVIS Prime gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic JARVIS Prime — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "JARVIS Prime",
            "welcome": "Welcome to JARVIS Prime! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
