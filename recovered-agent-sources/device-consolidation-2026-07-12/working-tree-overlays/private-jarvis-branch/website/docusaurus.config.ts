...
const config: Config = {
  title: 'JARVIS Prime',
  tagline: 'Local-first personal AI operating partner',
  favicon: 'img/favicon.ico',

  url: 'https://hermes-agent.nousresearch.com',
  baseUrl: '/docs/',

  organizationName: 'A-C-I-SOFTWARE-AND-DEVELOPMENT',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent',
          label: 'Home',
          position: 'right',
        },
        {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'GitHub Discussions', href: 'https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent' },
            { label: 'Nous Research', href: 'https://nousresearch.com' },
          ],
        },
      ],
      copyright: `JARVIS Prime fork maintained by A-C-I Software and Development. Built on Hermes Agent by <a href="https://nousresearch.com">Nous Research</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
