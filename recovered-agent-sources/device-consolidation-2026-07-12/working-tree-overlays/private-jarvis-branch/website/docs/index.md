...
slug: /
sidebar_position: 0
title: "JARVIS Prime Documentation"
description: "JARVIS Prime is a local-first personal AI operating partner forked from Hermes Agent."
...
JARVIS Prime is a local-first personal AI operating partner forked from [Hermes Agent](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent). It keeps the Hermes runtime and adds a personal operating layer for strategy, critique, mobile voice capture, memory, and builder/reviewer workflows.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/hermes-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>
