...
VALID_HOOKS: Set[str] = {
    ...
    "pre_llm_call",
    "post_llm_call",
    # Observer-only turn lifecycle hook.  Fired after the core loop has
    # assembled its final result, including completion, budget, tool-turn,
    # and token metrics.  This is the safe seam for quality evaluators and
    # telemetry: return values are ignored, so they cannot alter an answer.
    "post_turn",
    "pre_api_request",
    "post_api_request",
    "on_session_start",
