...
def _ensure_reference_path_allowed(path: Path) -> None:
    ...
    # `Path("~").expanduser()` uses USERPROFILE on Windows and ignores an
    # explicit HOME used by sandboxes/tests. Sensitive-home policy must follow
    # the configured home consistently across platforms.
