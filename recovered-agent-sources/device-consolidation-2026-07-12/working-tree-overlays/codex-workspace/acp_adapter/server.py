...
def _path_from_file_uri(uri: str) -> Path | None:
    ...
    # file:///C:/Users/... or C:\\Users\\... . Preserve the native Windows
    # path when Hermes itself runs on Windows; only WSL translates it to /mnt.
...
def _decode_text_bytes(data: bytes, mime_type: str | None) -> str | None:
    """Decode resource bytes into deterministic LF-normalized text."""
