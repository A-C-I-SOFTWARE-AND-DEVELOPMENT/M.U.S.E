...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def doRollover(self):
        try:
            ...
            # Windows does not allow renaming a log file held open by another
            # Hermes process. Logging must remain best-effort and must never
            # mask the application error that triggered the record. Reopen the
            # current file and defer rotation to a later emission/process.
