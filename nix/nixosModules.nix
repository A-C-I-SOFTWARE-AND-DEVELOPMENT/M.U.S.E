...
{ inputs, ... }: {
  ...
  in {
    ...
    exec_user=${cfg.user}
    hermes_bin=${containerDataDir}/current-package/bin/muse
          ...
          preStart = ''
            ...
            if [ "$NEED_CREATE" = "true" ]; then
              ...
              ${containerBin} create \
                ...
                ${cfg.container.image} \
                ${containerDataDir}/current-package/bin/muse gateway run --replace ${lib.concatStringsSep " " cfg.extraArgs}
