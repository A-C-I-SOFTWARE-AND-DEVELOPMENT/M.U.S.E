...
| <e.g. A.5.18> | Access rights | partial | `docs/security/rls-policy-catalog.md` (authored, not yet applied) | RLS not yet applied to live Postgres | `@echerd27-design` | `supabase-rls-applied` |
| ... | | | | | | |
