...
name: opencode
category: hermes
canonical_source: recovered-agent-sources/from-hermes-agent/autonomous-ai-agents/opencode/SKILL.md
...
- `skills/autonomous-ai-agents/opencode/SKILL.md` — `hermes-skill` / `live-skills`
