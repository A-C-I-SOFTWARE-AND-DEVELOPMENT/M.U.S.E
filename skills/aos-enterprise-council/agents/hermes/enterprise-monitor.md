...
category: hermes
canonical_source: recovered-agent-sources/from-hermes-agent/enterprise-council/monitor/SKILL.md
...
> Post-run reviewer: scans the audit trail, proposes improvements, hands them to the curator.

## Aliases (other sources defining the same `name:`)

- `skills/enterprise-council/monitor/SKILL.md` — `hermes-skill` / `live-skills`
