...
category: hermes
canonical_source: recovered-agent-sources/from-hermes-agent/enterprise-council/judge/SKILL.md
...
> Validator / Judge: schema + policy + parallel-pass cross-checks on every leaf result.

## Aliases (other sources defining the same `name:`)

- `skills/enterprise-council/judge/SKILL.md` — `hermes-skill` / `live-skills`
