...
category: hermes
canonical_source: recovered-agent-sources/from-hermes-agent/enterprise-council/operations/SKILL.md
...
> Operations leaf: logistics planning + execution, compliance checks + filings, incident declaration.

## Aliases (other sources defining the same `name:`)

- `skills/enterprise-council/operations/SKILL.md` — `hermes-skill` / `live-skills`
