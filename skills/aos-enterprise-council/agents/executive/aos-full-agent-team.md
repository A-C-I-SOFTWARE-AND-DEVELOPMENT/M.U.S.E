...
category: executive
canonical_source: recovered-agent-sources/from-hermes-agent/aos-full-agent-team/SKILL.md
...
> Full AoS council: spin up all 16 specialists end-to-end.

## Aliases (other sources defining the same `name:`)

- `skills/aos-full-agent-team/SKILL.md` — `hermes-skill` / `live-skills`
