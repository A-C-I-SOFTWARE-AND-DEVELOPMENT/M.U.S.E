...
name: codex
category: codex
canonical_source: recovered-agent-sources/from-hermes-agent/autonomous-ai-agents/codex/SKILL.md
...
- `skills/autonomous-ai-agents/codex/SKILL.md` — `hermes-skill` / `live-skills`
