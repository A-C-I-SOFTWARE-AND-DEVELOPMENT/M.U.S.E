...
canonical_source: recovered-agent-sources/from-hermes-agent/autonomous-ai-agents/claude-code/SKILL.md
...
**Category:** Claude Code / Developer Workflow Layer
...
- `skills/autonomous-ai-agents/claude-code/SKILL.md` — `hermes-skill` / `live-skills`
