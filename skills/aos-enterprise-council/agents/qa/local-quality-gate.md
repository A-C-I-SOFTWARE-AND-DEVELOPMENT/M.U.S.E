...
category: qa
canonical_source: skills/local-quality-gate/SKILL.md
...
> Run local validation gates against a workspace before publishing — git/secrets/lang/Hermes checks with a publish-block on critical failures.
