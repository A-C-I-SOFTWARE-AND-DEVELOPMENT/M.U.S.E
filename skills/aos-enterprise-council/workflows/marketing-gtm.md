...
Commercial Office (HazMat Market Positioning, ASO/SEO, Launch
...
GTM Brief (`docs/templates/gtm-brief-template.md`). Competitor
...
2. HazMat Market Positioning Agent drafts the GTM Brief
   (`hazmat-market-positioning` skill).
...
- Builder: Launch Campaign Agent / HazMat Market Positioning
  Agent.
