...
1. **Mission Brief** — chief-orchestrator authors using
   `docs/templates/mission-brief-template.md`. Restates owner intent,
...
2. **Evidence Bundle** — research-evidence-bureau assembles repo
   ...
   risks. Uses `docs/templates/evidence-bundle-template.md`. Commits
...
4. **Plan generation (parallel)** — N skills dispatched in
   ...
   `docs/templates/multi-plan-set-template.md`. Commits to
...
5. **Plan comparison and scoring (parallel)** — skill
   ...
   `docs/templates/plan-comparison-matrix-template.md`. Appends to
...
6. **Synthesis** — skill `master-plan-synthesis` produces the
   ...
   Uses `docs/templates/synthesized-master-plan-template.md`.
...
7. **Red-team review** — skill `red-team-plan-review` attacks the
   ...
   `docs/templates/red-team-plan-review-template.md`. Commits to
...
10. **Execution blueprint** — skill `execution-blueprint-compile`
    ...
    `docs/templates/execution-blueprint-template.md`. Commits to
