...
**Use the `guide-first` skill.** Citing a URL is not enough. Distill to
numbered LEGO steps (`instruction-card.json`), execute in order, judge,
swap the guide if the kit is still blocky. Ledger:
`../../guide-first/references/guide-ledger.md`.
