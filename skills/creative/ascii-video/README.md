...
Built for [Hermes Agent](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/muse). Usable in any coding agent. Canonical source lives here; synced to [`A-C-I-SOFTWARE-AND-DEVELOPMENT/muse/skills/creative/ascii-video`](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/muse/tree/main/skills/creative/ascii-video) via PR.
