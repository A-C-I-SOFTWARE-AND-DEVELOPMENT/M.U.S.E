...
Built for [Hermes Agent](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E). Usable in any coding agent. Canonical source lives here; synced to [`A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E/skills/creative/ascii-video`](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E/tree/main/skills/creative/ascii-video) via PR.
