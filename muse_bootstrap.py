...
(``muse``, ``muse-agent``, ``muse-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import muse_bootstrap``
# (or ``from muse_bootstrap import apply_windows_utf8_bootstrap``) at
