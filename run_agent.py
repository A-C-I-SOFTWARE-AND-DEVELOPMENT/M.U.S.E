...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        ...
        try:
            ...
            from muse_cli.models import ensure_lmstudio_model_loaded
    ...
    def _memory_layers_enabled(self) -> bool:
        ...
        enabled = False
        try:
            from muse_cli.config import cfg_get, load_config
    ...
    def _supports_reasoning_extra_body(self) -> bool:
        ...
        if (
            ...
            try:
                from muse_cli.models import github_model_reasoning_efforts
    ...
    def _lmstudio_reasoning_options_cached(self) -> list[str]:
        ...
        if cached is not None:
            ...
            if opts or (_time.monotonic() - ts) < 60:
                return opts
        try:
            from muse_cli.models import lmstudio_model_reasoning_options
