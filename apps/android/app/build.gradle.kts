...
android {
    ...
    testOptions {
        unitTests {
            // Lets JVM unit tests call android.util.Log and friends
            // without an instrumentation runner. The emergency stop
            // controller writes to LogBuffer which forwards to
            // android.util.Log, and we want those tests to be plain
            // JVM-fast.
