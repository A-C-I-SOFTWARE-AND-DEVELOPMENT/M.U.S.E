...
object DefaultToolProfiles {
    val CODEX = AiToolProfile(
        ...
        notes = "Uses official ChatGPT/Codex login where available. No API key required by Hermes.",
    ...
    val CHATGPT = AiToolProfile(
        ...
        notes = "Uses existing ChatGPT subscription. Hermes does not call the OpenAI API.",
    ...
    val CLAUDE_CODE = AiToolProfile(
        ...
        launchMethod = "official_tool_or_manual_handoff",
        notes = "Uses official Claude Code workflow where allowed. Hermes does not proxy Claude subscriptions.",
    ...
    val CLAUDE = AiToolProfile(
        ...
        launchMethod = "manual_handoff_or_deeplink_if_available",
        notes = "Uses existing Claude subscription. Hermes does not call the Anthropic API.",
