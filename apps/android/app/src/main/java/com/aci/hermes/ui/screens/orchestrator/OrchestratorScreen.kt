...
import com.aci.hermes.ui.jarvis.JarvisPrimeIcon
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    JarvisPrimeIcon(
                        state = state.jarvisIconState,
                        onTap = { viewModel.onJarvisTap() },
                        onHold = { viewModel.onJarvisHold() },
                        onLongPress = { viewModel.onJarvisLongPress() },
                        onDoubleTap = { viewModel.onJarvisDoubleTap() },
                        onSwipeUp = { viewModel.onJarvisSwipeUp() },
                        size = 40.dp,
