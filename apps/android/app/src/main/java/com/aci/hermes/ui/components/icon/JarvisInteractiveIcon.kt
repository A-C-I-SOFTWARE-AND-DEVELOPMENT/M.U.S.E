 ...
 * `IconAppearance` rather than branching on the state. Pulse amplitude
 * comes from the appearance recipe, which keeps OFFLINE and BLOCKED
 * naturally still (amplitude 0f). [reducedMotion] forces the pulse
 * off regardless.
 *
