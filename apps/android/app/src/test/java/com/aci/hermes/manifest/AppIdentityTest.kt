...
/**
 * Pins the Jarvis Prime user-facing identity and the technical
 * package identifier.
 *
 *   * User-facing name (everywhere a label is rendered): "Jarvis Prime"
...
class AppIdentityTest {
    ...
    @Test
    fun `app_name in strings_xml is exactly Jarvis Prime`() {
        ...
        assertEquals(
            "User-facing app name must be 'Jarvis Prime'",
            "Jarvis Prime",
            match!!.groupValues[1],
        )
    }
