...
export const UNIVERSE_ROUTES = [
  ...
  route('/jobs', 'Jobs', 'crown', 'atlas-crown', 'command-bridge', 'station-room', 'runtime:read', 'Live orchestration jobs from the Muse gateway.'),
  route('/approvals', 'Approvals', 'crown', 'quarantine-moon', 'security-airlock', 'station-room', 'approval:read', 'Owner-gated actions awaiting authorization.'),
  route('/autonomy', 'Autonomy', 'crown', 'atlas-crown', 'engineering', 'station-room', 'settings:write', 'Live B0–B3 autonomy band controls.'),
