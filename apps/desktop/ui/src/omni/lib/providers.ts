...
export const PROVIDERS: Provider[] = [
  ...
  { id: 'ollama', label: 'Ollama (local)', baseUrl: 'http://localhost:11434/v1', keyEnv: 'OLLAMA_API_KEY', browserDirect: true, shape: 'openai', local: true, curated: ['gemma4:e2b', 'qwen3.5:9b', 'gpt-oss:20b'], note: 'Set OLLAMA_ORIGINS to allow the browser.' },
  { id: 'ollama-cloud', label: 'Ollama Cloud', baseUrl: 'https://ollama.com/v1', keyEnv: 'OLLAMA_API_KEY', browserDirect: true, shape: 'openai', curated: ['nemotron-3-ultra', 'kimi-k3', 'glm-5.2', 'deepseek-v4-pro', 'qwen3.5:397b', 'gpt-oss:120b', 'minimax-m3', 'gemma4:31b'], note: 'Hosted Ollama models with your ollama.com key.' },
