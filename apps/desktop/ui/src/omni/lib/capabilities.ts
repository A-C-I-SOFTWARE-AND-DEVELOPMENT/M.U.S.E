...
export const CAPABILITIES: Capability[] = [
  ...
  { id: 'approvals', title: 'Owner Approvals', blurb: 'Owner-gated actions (spend, deploy, publish, OAuth, credentials) remain deferred until the owner authorizes them.', plane: 'governance', accent: '#FFB020', surface: { kind: 'tab', to: '/approvals' }, endpoint: '/v1/cockpit/approvals' },
