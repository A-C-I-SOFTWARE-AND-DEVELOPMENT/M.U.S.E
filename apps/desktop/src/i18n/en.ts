...
export const en: Translations = {
  ...
  boot: {
    ready: 'M.U.S.E. Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading muse settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting M.U.S.E. Desktop…'
    },
    errors: {
      backgroundExited: 'muse background process exited.',
      backgroundExitedDuringStartup: 'muse background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your muse backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update muse',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting M.U.S.E. Desktop.',
    ...
    native: {
      ...
      inputBody: 'muse is waiting for your response.',
      turnDoneTitle: 'muse finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to muse defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones muse writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while muse is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'muse asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while muse was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let muse follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what muse is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen muse, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'muse checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading muse configuration...',
    ...
    gateway: {
      ...
      intro:
        'M.U.S.E. Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running muse backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private muse backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote muse backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'M.U.S.E. Cloud',
      cloudDesc: 'Sign in once to M.U.S.E. Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'M.U.S.E. Cloud',
      cloudSignIn: 'Sign in to M.U.S.E. Cloud',
      cloudSignedIn: 'Signed in to M.U.S.E. Cloud',
      cloudNeedsSignIn: 'Sign in to M.U.S.E. Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your M.U.S.E. Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'M.U.S.E. Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of M.U.S.E. Cloud',
      cloudSignedOutMessage: 'Cleared the M.U.S.E. Cloud session.',
      ...
      restartingMessage: 'M.U.S.E. Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · muse ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. muse runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point muse at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As muse builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart muse to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update muse to generate pets.',
      backgroundHint: 'You can close this — muse will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure muse desktop' },
    ...
    hermesActiveSessions: (version, count) => `muse ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent muse environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. muse will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the muse backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from muse. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting muse...',
    placeholderReconnecting: 'Reconnecting to muse…',
    ...
    attachUrlDesc: 'muse will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating muse…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting muse…',
    ...
    unsupportedMessage: 'This version of muse can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of muse is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected muse backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed muse from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'muse will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the M.U.S.E. desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The muse updater takes over in its own window and reopens muse automatically when it’s done. Please don’t reopen muse yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. muse reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then muse reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'muse needs a one-time install',
    ...
    settingUpTitle: 'Setting up M.U.S.E.',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another muse CLI or desktop instance is running. Stop any running muse instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with M.U.S.E.",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'muse is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting muse…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run muse',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point muse at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — muse connects automatically',
    ...
    authorizeThere: 'Authorize muse there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize muse there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `M.U.S.E. Desktop v${version}`,
      ...
      gatewayTitle: 'muse inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. muse will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'muse is restarting...',
      askRestart: 'Ask muse to restart the server',
      lookingRestart: taskId => `muse is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'muse is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `muse finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'muse could not restart the server.',
      stillWorking:
        'muse is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'muse is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'muse gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). muse won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'muse needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'muse needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart M.U.S.E. Desktop to use Save Image.',
    restartToSaveImages: 'Restart M.U.S.E. Desktop to save images',
