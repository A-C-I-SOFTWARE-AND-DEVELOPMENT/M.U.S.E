...
# Floors calibrated against pristine upstream on 2026-08-20:
# hermes_cli 287, gateway 91, agent 196, tools 148. Set at ~70% so an
# ordinary deletion does not trip them -- only a discovery collapse does.
# These floors RISE as consolidation tranches land modules; raise them
# deliberately, never lower them to make a red run green.
