...
Note: fusion mode is mocked off in all tests so that the status bar shows
the actual configured model slug (e.g. "claude-opus-4.6") rather than the
collective brand name "Axiom".  The fusion-aware display path is tested
separately in test_cli_status_bar.py.
"""
...
# -------------------------------------------------------------------
# Fusion is OFF in all background-indicator tests — we test the single-
