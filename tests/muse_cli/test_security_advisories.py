"""Tests for muse_cli.security_advisories.
...
import muse_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full muse_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "muse_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "muse_cli.config.save_config",
