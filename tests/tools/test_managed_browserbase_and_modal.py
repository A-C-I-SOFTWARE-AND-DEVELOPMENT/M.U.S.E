...
def _enable_managed_nous_tools(monkeypatch):
    ...
    muse_cli.auth and muse_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("muse_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("muse_cli.models.check_nous_free_tier", lambda: False)
