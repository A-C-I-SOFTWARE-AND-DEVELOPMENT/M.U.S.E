"""
Tests for timezone support (muse_time module + integration points).
...
def _reset_hermes_time_cache():
    """Reset the muse_time module cache (replacement for removed reset_cache)."""
    muse_time._cached_tz = None
    muse_time._cached_tz_name = None
    muse_time._cache_resolved = False


# =========================================================================
# muse_time.now() — core helper
# =========================================================================
...
class TestHermesTimeNow:
    ...
    def test_invalid_timezone_falls_back(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="muse_time"):
            result = muse_time.now()
