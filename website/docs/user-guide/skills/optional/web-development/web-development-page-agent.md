...
- User wants **M.U.S.E. itself to drive a browser** → use M.U.S.E.' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
