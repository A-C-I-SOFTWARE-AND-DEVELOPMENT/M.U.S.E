...
| | |
|---|---|
| Source | Optional — install with `muse skills install official/productivity/canvas` |
...
4. Name the token (e.g., "M.U.S.E."), set an optional expiry, and click **Generate Token**
