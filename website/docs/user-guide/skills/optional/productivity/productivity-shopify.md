...
| | |
|---|---|
| Source | Optional — install with `muse skills install official/productivity/shopify` |
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"M.U.S.E.","productType":"Apparel","tags":["test"]}}'
```
