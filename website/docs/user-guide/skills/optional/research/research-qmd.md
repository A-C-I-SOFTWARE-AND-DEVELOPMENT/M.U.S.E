...
| | |
|---|---|
| Source | Optional — install with `muse skills install official/research/qmd` |
...
M.U.S.E. via the native MCP client. This is the preferred
...
Then configure M.U.S.E. to connect via HTTP:
