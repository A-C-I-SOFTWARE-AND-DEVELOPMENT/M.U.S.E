...
| | |
|---|---|
| Source | Optional — install with `muse skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), M.U.S.E. |
| License | MIT |
...
import upstream classes into M.U.S.E. itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside M.U.S.E. core.
