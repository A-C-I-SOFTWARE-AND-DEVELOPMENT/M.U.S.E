...
| | |
|---|---|
| Source | Optional — install with `muse skills install official/security/1password` |
| Path | `optional-skills/security/1password` |
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by M.U.S.E. |
| License | MIT |
...
- `tmux` available for stable authenticated sessions during M.U.S.E. terminal calls (desktop app flow only)
...
### Service Account (recommended for M.U.S.E.)
...
## M.U.S.E. Execution Pattern (desktop app flow)

M.U.S.E. terminal commands are non-interactive by default and can lose auth context between calls.
