...
| Version | `1.1.0` |
| Author | muse (adapted from obra/superpowers) |
| License | MIT |
...
> **For muse** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use muse tools to understand the project:
