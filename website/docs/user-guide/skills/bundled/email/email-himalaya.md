...
To reply non-interactively from muse read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from muse)** — pipe the message via stdin:
