...
To reply non-interactively from M.U.S.E., read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from M.U.S.E.)** — pipe the message via stdin:
