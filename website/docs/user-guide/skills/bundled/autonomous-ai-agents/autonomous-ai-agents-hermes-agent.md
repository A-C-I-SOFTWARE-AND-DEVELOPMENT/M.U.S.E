...
muse status [--all]       Show component status
```
...
```
muse insights [--days N]  Usage analytics
muse update               Update to latest version
muse pairing list/approve/revoke  DM authorization
...
muse acp                  ACP server (IDE integration)
