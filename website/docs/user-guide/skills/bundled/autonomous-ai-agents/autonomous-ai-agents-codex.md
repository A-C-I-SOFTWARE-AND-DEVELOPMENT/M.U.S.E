...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the muse terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For muse itself, `model.provider: openai-codex` uses Hermes-managed Codex
