...
When M.U.S.E. runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use M.U.S.E.' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. M.U.S.E.'s deliverable
