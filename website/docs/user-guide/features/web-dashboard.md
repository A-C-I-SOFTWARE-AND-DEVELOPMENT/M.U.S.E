...
| Theme | Character |
|-------|-----------|
| **muse Teal** (`default`) | Dark teal + cream, system fonts, comfortable spacing |
| **muse Teal (Large)** (`default-large`) | Same as default with 18px text and roomier spacing |
