...
[PR #12550](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/muse/pull/12550) proposed a
...
One `asyncio.Task` running in a background daemon thread per muse `task_id`.
