...
[PR #12550](https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E/pull/12550) proposed a
...
One `asyncio.Task` running in a background daemon thread per M.U.S.E. `task_id`.
