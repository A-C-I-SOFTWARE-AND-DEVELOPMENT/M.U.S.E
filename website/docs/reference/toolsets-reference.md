...
description: "Reference for muse core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call muse tools programmatically. |
