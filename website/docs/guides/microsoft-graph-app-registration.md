...
4. Fill in:
   - **Name:** `muse Teams Meeting Pipeline` (or any name you'll recognize).
...
```powershell
# Create a policy scoped to the muse app
New-CsApplicationAccessPolicy `
  -Identity "Hermes-Meeting-Pipeline-Policy" `
  -AppIds "<MSGRAPH_CLIENT_ID>" `
  -Description "Restrict muse meeting pipeline to allow-listed users"
...
muse ships a Graph auth smoke-test. From your muse install:
