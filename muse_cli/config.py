...
from muse_cli.default_soul import DEFAULT_SOUL_MD
...
# Re-export from muse_constants — canonical definition lives there.
from muse_constants import get_hermes_home  # noqa: F811,E402
...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    "security": {
        ...
        # ``muse_cli/security_advisories.py`` for the catalog.
        "acked_advisories": [],
...
def get_custom_provider_context_length(
    ...
    used by:
      ...
      * ``muse_cli.model_switch.resolve_display_context_length`` (``/model`` confirmation display)
