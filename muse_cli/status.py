...
from muse_cli.auth import AuthError, resolve_provider
from muse_cli.colors import Colors, color
from muse_cli.config import get_env_path, get_env_value, get_hermes_home, load_config
...
def show_status(args):
    ...
    if _effective_provider_label() == "LM Studio":
        from muse_cli.models import probe_lmstudio_models
        model_cfg = config.get("model")
    ...
    try:
        from muse_cli.gateway import get_gateway_runtime_snapshot, _format_gateway_pids
