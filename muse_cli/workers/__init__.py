...
module (e.g. ``muse_cli.workers.codex``) and registers itself via
...
from muse_cli.workers.isolation import (
    CollectedRun,
    IsolatedSpawner,
    IsolatedWorkspace,
    IsolationError,
...
from muse_cli.workers.registry import (
    WorkerRegistry,
    default_registry,
    get,
    known_workers,
...
def builtin_worker_classes() -> list:
    ...
    """
    from muse_cli.workers.aider_handoff import AiderExecuteWorker, AiderHandoffWorker
    from muse_cli.workers.claude_handoff import ClaudeExecuteWorker, ClaudeHandoffWorker
    from muse_cli.workers.codex_handoff import CodexExecuteWorker, CodexHandoffWorker
    from muse_cli.workers.goose_handoff import GooseExecuteWorker, GooseHandoffWorker
    from muse_cli.workers.local_planner import LocalPlannerWorker
    from muse_cli.workers.sia import SiaWorker
