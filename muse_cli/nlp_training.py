...
``muse_cli/jarvis_prime/nlp_training.py`` exports validated NL-compile traces
...
CLI::
    ...
    python -m muse_cli.nlp_training scan
    python -m muse_cli.nlp_training validate data/approved/together_train.jsonl
    python -m muse_cli.nlp_training approve data/approved/together_train.jsonl --only-if-valid
    python -m muse_cli.nlp_training together-create-job data/approved/together_train.jsonl --yes-start-paid-training
"""
