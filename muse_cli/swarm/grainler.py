...
* a **deterministic** core that turns specs into :class:`~muse_cli.swarm.grain.Grain`
  objects, **proves their file-domains disjoint**, and lowers the plan to an
  :class:`~muse_cli.orchestrator_parallel.ExecutionPlan`.
...
def partition(
    ...
    *,
    ...
    is run here and raises :class:`~muse_cli.swarm.grain.OverlapError` before
