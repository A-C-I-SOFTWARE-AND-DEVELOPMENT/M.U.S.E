...
def _has_healthy_oauth_fallback_for_apikey_provider(provider_label: str) -> bool:
    ...
    if normalized in {"google / gemini", "gemini"}:
        try:
            from muse_cli.auth import get_gemini_oauth_auth_status
            return bool((get_gemini_oauth_auth_status() or {}).get("logged_in"))
        except Exception:
            return False
    if normalized == "minimax":
        try:
            from muse_cli.auth import get_minimax_oauth_auth_status
...
def _build_apikey_providers_list() -> list:
    ...
    try:
        ...
        try:
            from muse_cli.providers import normalize_provider as _normalize_provider
...
def run_doctor(args):
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from muse_cli.config import get_compatible_custom_providers as _compatible_custom_providers
            ...
            if runtime_provider and runtime_provider not in ("auto", "custom"):
                try:
                    if runtime_provider == "openrouter":
                        ...
                        from muse_cli.auth import PROVIDER_REGISTRY, get_auth_status
        ...
        if fallback_config.exists():
            ...
            if should_fix:
                ...
                if example_config.exists():
                    ...
                    from muse_cli.config import DEFAULT_CONFIG, save_config
    ...
    if config_path.exists():
        try:
            from muse_cli.config import check_config_version, migrate_config
    ...
    if soul_path.exists():
        ...
        if should_fix:
            ...
            soul_path.write_text(
                "# MUSE Persona\n\n"
                "<!-- Edit this file to customize how MUSE communicates. -->\n\n"
    ...
    try:
        from muse_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
