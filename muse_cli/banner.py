...
from muse_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
_UPSTREAM_REPO_URL = "https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E.git"
...
_RELEASE_URL_BASE = "https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E repo (forks don't get a link).
    """
...
def format_banner_version_label() -> str:
    ...
    base = f"M.U.S.E. v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else MUSE_GLYPH
    except Exception:
        _bskin = None
        _hero = MUSE_GLYPH
    left_lines = ["", _hero, ""]
    ...
    try:
        from muse_cli.codex_runtime_switch import get_current_runtime
        from muse_cli.config import load_config as _load_cfg
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from muse_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else MUSE_WORDMARK
        console.print(_logo)
        console.print()
