...
from muse_cli.jarvis_prime.gates import GateSummary, run_gate_summary
...
def compile_request(
    ...
    *,
    ...
    if clarifications:
        from muse_cli.jarvis_prime.nlp_refine import apply_clarifications
    ...
    refinement = None
    if refine_exec:
        from muse_cli.jarvis_prime.nlp_refine import run_execution_refinement
...
def _grammar_check(result: CompileResult) -> Optional[dict]:
    ...
    try:
        from muse_cli.jarvis_prime.nlp_grammar import get_grammar
