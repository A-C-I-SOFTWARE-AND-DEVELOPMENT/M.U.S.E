...
from muse_cli.jarvis_prime.awareness import (
    AwarenessSnapshot,
...
from muse_cli.jarvis_prime.persona import Persona, PersonaPrompt
from muse_cli.jarvis_prime.reasoning import Inference, Reasoner
...
from muse_cli.jarvis_prime.router import RouteDecision, RouteTarget, Router
from muse_cli.jarvis_prime.self_update import ProposalBook
...
class JarvisPrime:
    ...
    Or wire into a gateway: see ``muse_cli/main.py`` slash-command
    ...
    def _build_auto_gemma_runner(self):
        ...
        try:
            if factory is not None:
                return factory()
            from muse_cli.jarvis_prime.gemma_runner import (
                auto_runner_enabled,
                build_gemma_runner,
            )
    ...
    def delegate(
        ...
        try:
            from muse_cli import model_router as _mr
    ...
    def stop(self, reason: str = "owner_requested") -> dict[str, Any]:
        ...
        leases_cleared = 0
        try:
            from muse_cli.jarvis_prime import worker_locks as _wl
