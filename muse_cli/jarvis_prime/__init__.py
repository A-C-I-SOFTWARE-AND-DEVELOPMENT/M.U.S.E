...
from muse_cli.jarvis_prime.memory import (
    MemoryRecord,
    MemoryStore,
)
...
from muse_cli.jarvis_prime.owner_brief import (
    OwnerBrief,
    build_owner_brief,
)
...
from muse_cli.jarvis_prime.tokenjuice import (
    CompiledContext,
    ContextSection,
    TokenJuiceCompiler,
)
...
from muse_cli.jarvis_prime.router import (
    RouteDecision,
    RouteTarget,
    Router,
)
...
from muse_cli.jarvis_prime.navigation import (
    EditSite,
    IssueLocalizer,
    NavigationResult,
    Navigator,
...
def __getattr__(name: str):
    if name == "JarvisPrime":
        ...
        return JarvisPrime
    raise AttributeError(f"module 'muse_cli.jarvis_prime' has no attribute {name!r}")
