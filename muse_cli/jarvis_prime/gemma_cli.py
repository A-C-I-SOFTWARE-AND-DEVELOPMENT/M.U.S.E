...
(``muse_cli/main.py``) only needs a thin parser + a one-line dispatch hook.
Subcommands:
...
def _cmd_scorecards(args: argparse.Namespace) -> int:
    from muse_cli.jarvis_prime.model_scorecard import ScorecardBook, model_family
...
def _cmd_promote(args: argparse.Namespace) -> int:
    ...
    if getattr(args, "json", False):
        ...
        if dry_run:
            ...
            print("  approve via: muse_cli.jarvis_prime proposals list / approve")
    return 0
