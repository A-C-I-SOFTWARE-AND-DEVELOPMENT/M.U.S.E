...
CLI:
    python -m muse_cli.jarvis_prime.axiom_bridge status
    python -m muse_cli.jarvis_prime.axiom_bridge audit      # exit 1 iff chain invalid
    python -m muse_cli.jarvis_prime.axiom_bridge tail [-n N]
"""
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m muse_cli.jarvis_prime.axiom_bridge",
