...
docs, Research Vault, Memory Tree, ledgers). It is therefore safe to delete
and rebuild at any time — deleting ``~/.hermes/jarvis_prime/graph/graph.json``
...
def default_graph_path() -> Path:
    return _hermes_home() / "jarvis_prime" / "graph" / "graph.json"
