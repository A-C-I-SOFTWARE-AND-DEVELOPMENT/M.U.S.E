...
CLI:
    python -m muse_cli.jarvis_prime.research_fabric.ue5 ping
    python -m muse_cli.jarvis_prime.research_fabric.ue5 discover
    python -m muse_cli.jarvis_prime.research_fabric.ue5 console "stat fps"
    python -m muse_cli.jarvis_prime.research_fabric.ue5 py "import unreal; unreal.log('MUSE')"
    python -m muse_cli.jarvis_prime.research_fabric.ue5 render <project> <map> <sequence>
"""
...
def launch_offscreen_render(
    ...
    *,
    ...
    if os.environ.get(SPAWN_ENV) != "1":
        ...
        return result
    try:
        from muse_cli.jarvis_prime.axiom_bridge import _hermes_home
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        prog="python -m muse_cli.jarvis_prime.research_fabric.ue5",
