"""CLI for the research fabric — ``python -m muse_cli.jarvis_prime.research_fabric``.
...
from muse_cli.jarvis_prime.guardrail_evidence import GuardrailEvidenceBundle, hermes_home
