...
from muse_cli.jarvis_prime.guardrail_evidence import GuardrailLedger, hermes_home
from muse_cli.jarvis_prime.owner_auth import OwnerAuthorizationGrant
...
PROTECTED_PATH_MARKERS: tuple[str, ...] = (
    ...
    "muse_cli/jarvis_prime/gates.py",
    "muse_cli/jarvis_prime/constitution.py",
    "muse_cli/jarvis_prime/capability_wall.py",
    "muse_cli/jarvis_prime/guardrail_evidence.py",
    "muse_cli/jarvis_prime/self_update.py",
    "muse_cli/jarvis_prime/research_fabric/validators.py",
    "muse_cli/jarvis_prime/research_fabric/charter.py",
    "muse_cli/jarvis_prime/research_fabric/controller.py",
    "muse_cli/jarvis_prime/research_fabric/monitor.py",
    "muse_cli/jarvis_prime/research_fabric/verifier",
