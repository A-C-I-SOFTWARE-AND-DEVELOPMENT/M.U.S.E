...
that a worker model (Claude Code / Codex / Aider) or the owner can read to
orient quickly. This is the HyperAgent "repo map" artifact: files grouped by
role, with their key symbols, kept under a token budget.
"""
