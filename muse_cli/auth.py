...
from muse_cli.config import get_hermes_home, get_config_path, read_raw_config
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from muse_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _nous_shared_auth_dir() -> Path:
    ...
    :func:`muse_constants.get_default_hermes_root` returns — so
...
def _prompt_model_selection(
    ...
    """
    from muse_cli.models import _format_price_per_mtok
    ...
    *,
    ...
    if not code_verifier:
        raise AuthError(
            ...
            "https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E/issues/26990.",
            provider="xai-oauth",
