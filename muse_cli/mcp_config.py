...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from muse_cli.cli_output import prompt as _shared_prompt
...
def cmd_mcp_add(args):
    ...
    # muse_cli/main.py for why the dest is renamed.
...
def cmd_mcp_install(args):
    ...
    if getattr(args, "install_all", False):
        from muse_cli.mcp_catalog import install_all_entries
    ...
    from muse_cli.mcp_picker import install_by_name
