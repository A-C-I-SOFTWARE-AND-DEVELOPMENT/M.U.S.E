...
The orchestrator's :class:`muse_cli.orchestrator_api.JobStore` keeps job
...
through :func:`muse_cli.job_replay.rebuild_snapshot` and resume mid-job.
...
:func:`muse_cli.orchestrator_events.make_envelope` shape
...
(:func:`muse_cli.worktrees.sanitize_segment`); no FastAPI, no
...
from muse_cli.worktrees import WorktreeError, sanitize_segment
