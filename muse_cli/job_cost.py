...
against a configured budget via :func:`muse_cli.budget_policy.evaluate_budget`.
...
orchestrator API (``muse_cli.orchestrator_api``) records worker heartbeats
...
class JobCost:
    ...
    def budget_decision(
        ...
        *,
        ...
        Thin wrapper over :func:`muse_cli.budget_policy.evaluate_budget`.
