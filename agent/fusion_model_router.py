...
MODEL_SPECIALIZATIONS: Dict[str, Dict[QueryType, float]] = {
    ...
    "deepseek/deepseek-v4-pro": {
        QueryType.CODE: 0.96,
        QueryType.MATH: 0.94,
        QueryType.CREATIVE: 0.70,
        QueryType.ANALYTICAL: 0.93,
        QueryType.FACTUAL: 0.88,
        QueryType.MULTILINGUAL: 0.75,
        QueryType.VISION: 0.40,
        QueryType.GENERAL: 0.92,
    },
    "deepseek/deepseek-v4-flash": {
        QueryType.CODE: 0.88,
        QueryType.MATH: 0.82,
        QueryType.CREATIVE: 0.65,
        QueryType.ANALYTICAL: 0.80,
        QueryType.FACTUAL: 0.78,
        QueryType.MULTILINGUAL: 0.70,
        QueryType.VISION: 0.35,
    ...
    "qwen/qwen3-max": {
        ...
        QueryType.ANALYTICAL: 0.87,
        QueryType.FACTUAL: 0.88,
        QueryType.MULTILINGUAL: 0.95,
        QueryType.VISION: 0.70,
        QueryType.GENERAL: 0.88,
    },
    "qwen3.7-max": {
        QueryType.CODE: 0.88,
        QueryType.MATH: 0.86,
    ...
    "nvidia/nemotron-3-ultra-550b-a55b": {
        ...
        QueryType.ANALYTICAL: 0.95,
        QueryType.FACTUAL: 0.93,
        QueryType.MULTILINGUAL: 0.82,
        QueryType.VISION: 0.60,
        QueryType.GENERAL: 0.94,
    },
    "glm-5.2": {
        QueryType.CODE: 0.86,
        QueryType.MATH: 0.84,
    ...
    "local/ornith": {
        ...
        QueryType.VISION: 0.20,
        QueryType.GENERAL: 0.78,
    },
    "local/falcon-h1r": {
        QueryType.CODE: 0.85,
        QueryType.MATH: 0.97,
        QueryType.CREATIVE: 0.50,
        QueryType.ANALYTICAL: 0.90,
        QueryType.FACTUAL: 0.80,
        QueryType.MULTILINGUAL: 0.55,
        QueryType.VISION: 0.15,
