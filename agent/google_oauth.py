...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "muse looks for a locally installed gemini-cli to source the OAuth client. "
            "Either:\n"
...
<html><head><meta charset="utf-8"><title>M.U.S.E. — signed in</title>
<style>
...
<html><head><meta charset="utf-8"><title>M.U.S.E. — sign-in failed</title>
<style>
body {{ font: 16px/1.5 system-ui, sans-serif; margin: 10vh auto; max-width: 32rem; text-align: center; color: #222; }}
h1 {{ color: #b42318; }} p {{ color: #555; }}
</style></head>
<body><h1>Sign-in failed</h1><p>{message}</p>
<p>Return to your terminal — muse will walk you through a manual paste fallback.</p></body></html>
"""
