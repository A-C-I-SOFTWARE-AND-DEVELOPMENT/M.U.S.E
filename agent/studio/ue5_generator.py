...
def _pcg_config(manifest: WorldManifest) -> dict[str, Any]:
    graphs = []
    ...
    return {
        ...
        "pcg_graphs": graphs,
        "foliage_scatter": {
            "instances_per_km2": 50000,
            "cull_distance_m": 4096,
        },
        "rock_formation": {
            "cluster_size": (3, 8),
            "elevation_bias": 0.6,
...
""")
    ...
    if world_manifest:
        ...
        write("Config/PCGGraphs.json", json.dumps(_pcg_config(world_manifest), indent=2))
