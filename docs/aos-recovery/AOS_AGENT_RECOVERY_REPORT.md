...
> **Read this 341 as a routed-catalog tally, not a file count** (WC-4
> honesty propagation, following FU-18). Every row above counts
> *registry entries* — distinct frontmatter `name:` entries recovered
> across both source repos, including duplicates (248 vs 233 distinct
> top-level), reconstructed-from-context names, judgement-lens personas,
> and product roles. It is **not** 341 standalone agent definition
> files. On disk the installed pack's
