# Coding from your phone with JARVIS
...
```
phone: "build packet for X"        → JARVIS plans (no execution)
...
Ask in chat: *"JARVIS, builder mode. Prepare a build packet for: &lt;describe
the change&gt;."* JARVIS produces a **bounded work packet** — intent, risk
