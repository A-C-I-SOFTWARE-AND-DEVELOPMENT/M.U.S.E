...
# The architecture-carrying modules named in §4.2 / §8.2. Each entry is
# (packet subsystem, test path). A path that no longer exists is reported as a
# MISSING subsystem rather than silently dropped -- a gate that quietly shrinks
# is worse than no gate.
FOCUSED_SET: tuple[tuple[str, str], ...] = (
    ("Agent Factory", "tests/hermes_cli/jarvis_prime/aos_council/test_agent_factory.py"),
    ("Agent Market", "tests/hermes_cli/jarvis_prime/aos_council/test_agent_market.py"),
    ("Blackboard", "tests/hermes_cli/swarm/test_blackboard.py"),
    ("Grainler", "tests/hermes_cli/swarm/test_grainler.py"),
    ("swarm executor", "tests/hermes_cli/swarm/test_executor.py"),
    ("swarm coordinator", "tests/hermes_cli/swarm/test_coordinator.py"),
    ("AXIOM bridge", "tests/test_axiom_bridge.py"),
    ("GraphRAG", "tests/test_graphrag_graph.py"),
    ("Memory Tree", "tests/test_jarvis_prime_memory_tree.py"),
    ("Research Fabric ratchet", "tests/test_jarvis_prime_research_fabric_ratchet.py"),
    ("Research Fabric benchmarks", "tests/test_jarvis_prime_research_fabric_benchmarks.py"),
)
