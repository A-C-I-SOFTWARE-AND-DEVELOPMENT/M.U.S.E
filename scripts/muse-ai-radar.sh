...
#
# Usage:
#   scripts/muse-ai-radar.sh
#   scripts/muse-ai-radar.sh --tools claude-code,codex,aider
#   scripts/muse-ai-radar.sh --since 2026-01-01
#   scripts/muse-ai-radar.sh --effort high
...
- `<timestamp>-request.json` — written by `scripts/muse-ai-radar.sh`,
