...
VERSION_FILE = REPO_ROOT / "muse_cli" / "__init__.py"
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"muse-agent[acp]=={semver}"
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/A-C-I-SOFTWARE-AND-DEVELOPMENT/M.U.S.E",
