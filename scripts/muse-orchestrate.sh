...
USAGE
  bash scripts/muse-orchestrate.sh [flags] "<mission text>"
  bash scripts/muse-orchestrate.sh --help
  bash scripts/muse-orchestrate.sh --list
  bash scripts/muse-orchestrate.sh --status <job-id>
...
INVOCATION STYLES
  As a script:     bash scripts/muse-orchestrate.sh "..."
  Make executable: chmod +x scripts/muse-orchestrate.sh
                   ./scripts/muse-orchestrate.sh "..."
