...
_HERMES_CORE_TOOLS = [
    ...
    "kanban_complete", "kanban_block", "kanban_reject", "kanban_heartbeat",
...
TOOLSETS = {
    ...
    "skills": {
        ...
        "tools": ["skills_list", "skill_view", "skill_manage", "skill_search"],
        "includes": []
    },
    ...
    "kanban": {
        ...
        "tools": [
            ...
            "kanban_reject", "kanban_heartbeat", "kanban_comment",
